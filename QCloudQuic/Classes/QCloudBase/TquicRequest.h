...
- (instancetype)initWithURL:(NSURL *)url host:(NSString *)host httpMethod:(NSString *)httpMethod ip:(NSString *)ip body:(BodyType)body  headerFileds:(NSDictionary *)headerFileds ;
@end
